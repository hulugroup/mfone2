...
class Mage_Dataflow_Model_Convert_Parser_Extend_Csvetowe extends Mage_Dataflow_Model_Convert_Parser_Csv {


    var $__vendorName = 'default';
    var $__skuFieldName = 'SKU';
    var $__groupKeyName = 'ConfigurableSku';
    var $__nameFieldName = 'ConfigurableName';
...
//exit;
    ...
    protected function setConfigurableProduct(array $importData) {
        ...
        $return_data[$this->__skuFieldName] = $importData["ConfigurableSku"];
        $return_data['visibility'] = 'Catalog, Search';
        $return_data['type'] = 'configurable';
        $return_data['Name'] = $importData["ConfigurableName"];
